...
describe('UniqueEntityId', () => {
    ...
    it('should be able to compare two unique entity ids', () => {
        ...
        const uniqueEntityId3 = new UniqueEntityId('123e4567-e89b-12d3-a456-426614174000');
        const uniqueEntityId4 = new UniqueEntityId('123e4567-e89b-12d3-a456-426614174000');
